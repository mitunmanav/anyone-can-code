...
<details>
<summary>Optional — marketplace via command (still need hooks + restart + <code>$setup</code>)</summary>
...
*Video file:* [docs/media/install-setup.mp4](docs/media/install-setup.mp4) · *Full walkthrough:* [anyone-can-code.vercel.app/#install](https://anyone-can-code.vercel.app/#install)
