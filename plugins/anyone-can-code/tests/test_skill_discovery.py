...
EXPLICIT_ONLY = {"orchestrator", "govern", "bridge", "memory-hygiene", "bite-plan", "cost-guard", "rule-suggest", "checkpoint", "oneshot", "roster", "parallel-fix", "skeptic", "council", "you-brain", "auto-lint"}
