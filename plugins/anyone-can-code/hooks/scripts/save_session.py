...
def write_resume_artifacts(repo_root: Path, payload: dict, summary: str, workflow: dict) -> None:
    ...
    try:
        ...
        memory_core.atomic_write_text(
            layout["artifacts"] / "resume-note.md",
            "# Resume Note\n\n"
